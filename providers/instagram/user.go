...
const (
	...
	instagramFullName       string = "fullname"
	instagramProfilePicture string = "profile_picture"
)
...
func (u *User) FullName() string {
	return u.Data().Get(instagramFullName).Str()
}

// Name gets the users full name.
func (u *User) Name() string {
	return u.Data().Get(instagramName).Str()

}

// Nickname gets the users nickname or username.
func (u *User) Nickname() string {
	return u.Data().Get(instagramUsername).Str()

}

// AvatarURL gets the URL of an image representing the user.
func (u *User) AvatarURL() string {
	return u.Data().Get(instagramProfilePicture).Str()
}
